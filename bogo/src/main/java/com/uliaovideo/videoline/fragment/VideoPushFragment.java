...
import com.uliaovideo.videoline.adapter.OnlineUserAdapter;
import com.uliaovideo.videoline.api.Api;
import com.uliaovideo.videoline.base.BaseFragment;
import com.uliaovideo.videoline.json.JsonRequestGetOnlineUser;
import com.uliaovideo.videoline.json.JsonRequestUpdateLiveHeart;
import com.uliaovideo.videoline.manage.RequestConfig;
import com.uliaovideo.videoline.modle.OnlineUserModel;
    ...
    protected void initView(View view) {
        ...
        onlineUserAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                Common.callVideo(getContext(),onlineUserModels.get(position).getId());
            }
        });
