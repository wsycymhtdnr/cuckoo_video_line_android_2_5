...
import com.uliaovideo.videoline.inter.VideoDoClick;
import com.uliaovideo.videoline.json.JsonRequest;
import com.uliaovideo.videoline.json.JsonRequestBase;
import com.uliaovideo.videoline.json.JsonRequestDoGetVideoChatPageInfo;
import com.uliaovideo.videoline.json.JsonRequestGetVideoLive;
...
import com.uliaovideo.videoline.modle.TabLiveListModel;
...
import com.uliaovideo.videoline.utils.SlideImageLoader;
import com.uliaovideo.videoline.widget.VideoDoFragment;
        ...
        switch (v.getId()){
            ...
            case R.id.left_view:
                ...
                if(tabLiveListModelFirst != null){
                    ...
                    Common.callVideo(getContext(),tabLiveListModelFirst.getId());
                }
                break;
            ...
            case R.id.right_view:
                if(tabLiveListModelTree != null){
                    ...
                    Common.callVideo(getContext(),tabLiveListModelTree.getId());
                }
                break;
            default:
                break;
