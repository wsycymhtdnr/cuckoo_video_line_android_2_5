...
import com.uliaovideo.videoline.dao.DaoMaster;
import com.uliaovideo.videoline.dao.DaoSession;
...
import com.uliaovideo.videoline.helper.ContentUtils;
...
import com.uliaovideo.videoline.manage.JsonDataManage;
import com.uliaovideo.videoline.manage.SaveData;
import com.uliaovideo.videoline.modle.custommsg.CustomMsgVideoCall;
import com.uliaovideo.videoline.modle.custommsg.MsgModel;
import com.uliaovideo.videoline.modle.custommsg.TIMMsgModel;
import com.uliaovideo.videoline.ui.MainActivity;
import com.uliaovideo.videoline.ui.RegisterSelectActivity;
import com.uliaovideo.videoline.utils.CuckooSharedPreUtil;
import com.uliaovideo.videoline.utils.SDHandlerManager;
...
public class MyApplication extends Application {
    ...
    private void initOpenInstall() {
        if (com.uliaovideo.videoline.utils.Utils.isMainProcess(this)) {
    ...
    private void doAgainLogin(String title, String msg) {
        com.uliaovideo.videoline.utils.Utils.showMsgDialog(getApplicationContext(),
                title,
                msg,
                new MsgDialogClick() {
                    @Override
                    public void doYes(QMUIDialog dialog, int index) {
                        com.uliaovideo.videoline.utils.Utils.goActivity(getApplicationContext(), RegisterSelectActivity.class).finish();//重新登录
                    }
