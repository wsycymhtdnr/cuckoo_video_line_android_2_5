...
import com.uliaovideo.videoline.json.JsonRequestDoGetVideoEndInfo;
...
public class VideoLineEndActivity extends BaseActivity {
    ...
    protected void initSet() {
        ...
        if(isCallBeUser){
            ...
            mTvTypeName.setText(R.string.income);
        }else{
            tv_evaluate.setVisibility(View.VISIBLE);
            mTvTypeName.setText(R.string.consumpation);
        }
    }
        ...
        Api.doReuqestGetVideoEndInfo(uId,uToken,channelId,new StringCallback(){
            ...
            public void onSuccess(String s, Call call, Response response) {
                ...
                if(jsonObj.getCode() == 1){
                    mTvConsumption.setText(jsonObj.getData());
