...
import com.uliaovideo.videoline.widget.FullScreenVideoView;
...
public class RegisterSelectActivity extends BaseActivity implements PlatformActionListener {
    ...
    protected void initSet() {
        ...
        phoneNumberEdtext.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (com.uliaovideo.videoline.utils.Utils.isMobile(s.toString())) {
    ...
    //手机登录
    private void doPhoneLogin(String mobile, String code) {
    ...
    private void doSendCode() {
        if (com.uliaovideo.videoline.utils.Utils.isMobile(phoneNumberEdtext.getText().toString())) {
