package com.uliaovideo.videoline.api;
...
public class Api {
     ...
     * @param token token
     */
    public static void getAboutDataList(String uid,String token,StringCallback callback){
     ...
     * @param token token
     */
    public static void getFansDataList(String uid,String token,StringCallback callback){
     ...
     * @param img 轮播图文件集合
     */
    public static void saveUserDataAtCompile(String uid, String token, String user_nickname, File avatar, int sex, ArrayList<File> img,StringCallback callback){
     ...
     * @param code 验证码
     */
    public static void userLogin(String mobile,String code,String inviteCode,StringCallback callback){
    ...
    //拨打视频电话
    public static void doCallToUser(String userId, String userToken, String targetUserId, StringCallback callback) {

        OkGo.get(AppConfig.API_DOMAIN + "/video_call_api/video_call_0907")
                .params("uid",userId)
    ...
    public static void doHangUpVideoCall(String userId, String userToken, StringCallback callback) {
        OkGo.get(AppConfig.API_DOMAIN + "/video_call_api/hang_up_video_call")
                .params("uid",userId)
                .params("token",userToken)
    ...
    * */
    ...
    //发送礼物
    public static void doSendGift(String uid, String token, String count,String toUserId, String giftId,String channelId, StringCallback callback) {

        OkGo.get(AppConfig.API_DOMAIN + "/deal_api/send_gift")
                .params("uid",uid)
                .params("token",token)
                .params("to_user_id",toUserId)
                .params("gid",giftId)
    ...
    public static void doPlatAuthLogin(String platId,String inviteCode, JsonCallback callback) {
    ...
    public static void doRequestOneKeyCall(String uid, String token, StringCallback callback) {
        ...
        OkGo.get(AppConfig.API_DOMAIN + "/video_call_api/one_key_video_call")
