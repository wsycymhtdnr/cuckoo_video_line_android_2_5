package com.uliaovideo.videoline.utils.im;

import android.support.annotation.NonNull;

import com.alibaba.fastjson.JSON;
import com.uliaovideo.videoline.modle.custommsg.CustomMsgVideoCall;
import com.uliaovideo.videoline.modle.custommsg.CustomMsgVideoCallEnd;
...
public class IMHelp {
    ...
    //发送视频通话请求
    public static void sendVideoCallMsg(String channel, String toUserId, TIMValueCallBack<TIMMessage> callBack){
