...
import com.uliaovideo.videoline.msg.MsgTim;
import com.uliaovideo.videoline.msg.adapter.ChatAdapter;
import com.uliaovideo.videoline.msg.modle.Msg;
import com.uliaovideo.videoline.msg.modle.MsgModle;
import com.uliaovideo.videoline.widget.MsgTypeListLayout;
...
public class MsgActivity extends BaseActivity implements TextWatcher,TIMValueCallBack{
     ...
     * 保存聊天信息
     * @param isSend 是否发送成功
     * @param msgModleType 消息状态--0发出消息(right),1接受消息(left)
     * @param msg 消息
     */
