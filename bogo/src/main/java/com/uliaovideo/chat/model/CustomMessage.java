package com.uliaovideo.chat.model;
...
import com.uliaovideo.chat.utils.TimeUtil;
import com.uliaovideo.videoline.BuildConfig;
import com.uliaovideo.videoline.ICustomMsg;
...
public class CustomMessage extends Message {
    ...
    private void setPrivateMsgType(ChatAdapter.ViewHolder viewHolder, Context context, CustomMsgPrivateGift customMsgPrivateGift) {
        ...
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(MyApplication.getInstances().getResources().getColor(isSelf() ? R.color.gift_msg_color : R.color.black));
        if (message.isSelf()) {
            viewHolder.leftPanel.setVisibility(View.GONE);
            viewHolder.rightPanel.setVisibility(View.VISIBLE);
